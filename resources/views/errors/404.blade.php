<x-base-app-layout>
    <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0">
        ...
        <div class="text-center xl:max-w-4xl">
            <h1 class="mb-3 text-2xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl dark:text-white">Page non trouvée</h1>
            <p class="mb-5 text-base font-normal text-gray-500 md:text-lg dark:text-gray-400">Oups ! Il semble que vous ayez suivi un mauvais lien.</p>
