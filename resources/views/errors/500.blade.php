<x-base-app-layout>
    <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0">
        <div class="block md:max-w-lg">
            <img src="{{ asset('images/errors/500.svg') }}" alt="astronaut image">
        </div>
        <div class="text-center xl:max-w-4xl">
            <h1 class="mb-3 text-2xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl">Quelque chose a sérieusement mal tourné</h1>
            <p class="mb-5 text-base font-normal text-gray-500 md:text-lg">Il est toujours temps de faire une pause-café. Nous devrions être de retour le temps que vous finissiez votre café.</p>
